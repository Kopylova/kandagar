...
<br>
<display:table name="user" id="user" requestURI="get" pagesize="10" class="table table-striped table-bordered">
	...
	<display:column paramId="id" style="text-align: center; width:20px;white-space: nowrap;" title="">
		...
		<a class="icon-trash" title='<spring:message code="delete" />'
			href="javascript:void(0)" onclick = "RLS.Utils.areYouSure('<c:url value='/admin/user/delete/'/>${user.id}', RLS.Constants.annulledMessage)"
			></a>
	</display:column>
</display:table>
</body>
